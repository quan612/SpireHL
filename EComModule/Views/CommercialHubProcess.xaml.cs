...
namespace EComModule.Views
{
    /// <summary>
    /// Interaction logic for CommercialHubProcess.xaml
    /// </summary>
    public partial class CommercialHubProcess : UserControl
    {
        public CommercialHubProcess()
        {
            InitializeComponent();
        }
