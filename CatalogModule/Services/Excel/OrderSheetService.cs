...
{
    public class OrderSheetService : BaseExcelService
    {
        public override string SourceTemplate => ProjectDirectory + "OrderSheet.xlsx";
        public override string ExportTemplate
        {
            get
            {
                return "Order Sheet_" + DateTime.Now.ToString("yyyy-MM-dd hh-mm-ss") + ".xlsx";
            }
        }

        public OrderSheetService() : base()
        {
